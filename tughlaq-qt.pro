...
#   Bracket the code to profile with ProfileStart("tughlaq-qt.prof") and ProfileStop() and recompile
#   Run tughlaq-qt through its paces then exit
#   Analyze with:
#      pprof ./tughlaq-qt tughlaq-qt.prof
#   For a graphical view you need to: sudo apt-get install graphviz gv
#   Then run:
#      pprof --gv ./tughlaq-qt tughlaq-qt.prof
PROFILE = 0
...
macx:ICON = src/qt/res/icons/tughlaq.icns
macx:TARGET = "Tughlaq-Qt"
