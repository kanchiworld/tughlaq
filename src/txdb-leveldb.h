...
#include "bignum.h" //For CBigNum and uint256
#include "transaction.h" //For CTransacion and other tranaction related classes

class CDiskBlockIndex; //This is found in block.h, but dont want to include the whole file
...
public:
    ...
    bool ReadHashBestChain(uint256& g_hashBestChain);
    bool WriteHashBestChain(uint256 g_hashBestChain);
