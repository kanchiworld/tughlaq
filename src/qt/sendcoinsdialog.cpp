    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Tughlaq address (e.g. VTHZfUg11wEJmSgBLUcmCKGYekuqFcGHQq)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    {
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnitWithMaxDecimals(BitcoinUnits::TLQ, rcp.amount, BitcoinUnits::maxdecimals(BitcoinUnits::TLQ)), Qt::escape(rcp.label), rcp.address));
    }
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(BitcoinUnits::formatWithUnitFee(BitcoinUnits::TLQ, sendstatus.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Tughlaq address"));
        }
        else
        {
