...
//Q_IMPORT_PLUGIN(qminimal)
Q_IMPORT_PLUGIN(QMinimalIntegrationPlugin)
//Q_IMPORT_PLUGIN(qtlibpng)
#endif
...
{
	std::cout << "inside queueshutdown frestart = " << fRestart << std::endl;
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Tughlaq can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
{
    std::cout << "Gautam: Starting point bitcoin.cpp main from qt-gui app. frestart = " << fRestart << std::endl;
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "Tughlaq",
                              QString("Error: Specified data directory \"%1\" does not exist.").arg(QString::fromStdString(g_mapArgs["-datadir"])));
        return 1;
    }
    ...
    app.setOrganizationName("Tughlaq");
    //XXX app.setOrganizationDomain("");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("Tughlaq-Qt-testnet");
    else
        app.setApplicationName("Tughlaq-Qt");
        ...
        {
            {
                ...
                WalletModel walletModel(g_tughlaqWallet, &optionsModel);
