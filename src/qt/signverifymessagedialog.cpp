    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Tughlaq address (e.g. VTHZfUg11wEJmSgBLUcmCKGYekuqFcGHQq)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Tughlaq address (e.g. VTHZfUg11wEJmSgBLUcmCKGYekuqFcGHQq)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter Tughlaq signature"));
#endif
