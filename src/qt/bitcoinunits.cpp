...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TLQ);
    unitlist.append(mTLQ);
    unitlist.append(uTLQ);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case TLQ: return QString("TLQ");
    case mTLQ: return QString("mTLQ");
    case uTLQ: return QString::fromUtf8("μTLQ");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case TLQ: return QString("Tughlaqs");
    case mTLQ: return QString("Milli-Tughlaqs (1 / 1,000)");
    case uTLQ: return QString("Micro-Tughlaqs (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case TLQ:  return 100000000;
    case mTLQ: return 100000;
    case uTLQ: return 100;
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case TLQ: return 8; // 21,000,000 (# digits, without commas)
    case mTLQ: return 11; // 21,000,000,000
    case uTLQ: return 14; // 21,000,000,000,000
    default: return 0;
    }
}
