...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::TLQ).toInt();
    nDecimalPoints = settings.value("nDecimalPoints", BitcoinUnits::decimals(BitcoinUnits::TLQ)).toInt();
...
bool OptionsModel::Upgrade()
{
    ...
    assert(!g_strWalletFileName.empty());
